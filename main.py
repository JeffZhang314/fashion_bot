...
def main():
  ...
  path = os.path.abspath(__file__)[:-len("main.py")] #variables and stuff
  ...
  torch.save(annotated_batch, path + 'test.pt')



  loaded_batch, loaded_outfit_boundaries, loaded_likes, loaded_views = torch.load(path + 'test.pt')
